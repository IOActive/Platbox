...
void read_spi_bar_bios_bfpreg(DWORD64 SPIBAR, DWORD *pOut) {
	// SPI BIOS MMIO PRI (BIOS_BFPREG) - Offset 0h
	DWORD offset = 0;
	read_physical_memory(SPIBAR + offset, 4, pOut, FALSE);
}
...
void read_spi_bar_hsfs_ctl(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_faddr(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_dlock(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_freg0(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_freg1(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_freg2(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_freg3(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_freg4(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_freg5(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_fpr0(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_fpr1(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_fpr2(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_fpr3(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_bar_fpr4(DWORD64 SPIBAR, DWORD *pOut) {
...
void read_spi_interface_bar0_mmio(DWORD *pBar0Mmio) {
	...
	UINT32 offset1 = 0x10;
	*pBar0Mmio = read_pci_dword(0, 31, 5, offset1);
}
...
void read_spi_interface_bios_decode_enable(DWORD *pBiosSpiBDE) {
	...
	UINT32 offset1 = 0xD8;
	*pBiosSpiBDE = read_pci_dword(0, 31, 5, offset1);
}
...
void read_spi_interface_bios_control(DWORD *pBiosCtl) {
	// 
	UINT32 offset1 = 0xDC;
	*pBiosCtl = read_pci_dword(0, 31, 5, offset1);
}
...
void read_pmc_acpi_base_address(DWORD *pAcpiBase) {
	...
	UINT32 offset1 = 0x40;
	*pAcpiBase = read_pci_dword(0, 31, 2, offset1);
}
...
void read_pmc_acpi_control(DWORD *pAcpiControl) {
	// ACPI Control (ACTL)
	UINT32 offset1 = 0x44;
	*pAcpiControl = read_pci_dword(0, 31, 2, offset1);
}
...
void read_pmc_pm_base_address(DWORD *pPmBaseAddress) {
	...
	UINT32 offset1 = 0x48;
	*pPmBaseAddress = read_pci_dword(0, 31, 2, offset1);
}
...
void read_hostbridge_pxpepbar(DWORD64 *pPxpepbar) {
	...
	UINT32 offset1 = 0x40;
	UINT32 offset2 = 0x44;
	DWORD64 low = read_pci_dword(0, 0, 0, offset1);
	DWORD64 high = read_pci_dword(0, 0, 0, offset2);
...
void read_hostbridge_gmch(WORD *pGmch) {
	...
	UINT32 offset1 = 0x50;
	*pGmch = read_pci_word(0, 0, 0, offset1);
}
...
void read_hostbridge_deven(DWORD *pDeven) {
	// Device Enable (DEVEN)
	UINT32 offset1 = 0x54;
	*pDeven = read_pci_dword(0, 0, 0, offset1);	
}
...
void read_hostbridge_pavpc(DWORD *pPavpc) {
	...
	UINT32 offset1 = 0x58;
	*pPavpc = read_pci_dword(0, 0, 0, offset1);
}
...
void read_hostbridge_dpr(DWORD *pDpr) {
	...
	UINT32 offset1 = 0x5C;
	*pDpr = read_pci_dword(0, 0, 0, offset1);
}
...
void read_hostbridge_bdsm(DWORD *pBdsm) {
	...
	UINT32 offset1 = 0xB0;
	*pBdsm = read_pci_dword(0, 0, 0, offset1);
}
...
void read_hostbridge_bgsm(DWORD *pBgsm) {
	...
	UINT32 offset1 = 0xB4;
	*pBgsm = read_pci_dword(0, 0, 0, offset1);
}
...
void read_hostbridge_tseg(DWORD *pTseg) {
	...
	UINT32 offset1 = 0xB8;
	*pTseg = read_pci_dword(0, 0, 0, offset1);
}
...
void read_hostbridge_tolud(DWORD *pTolud) {
	...
	UINT32 offset1 = 0xBC;
	*pTolud = read_pci_dword(0, 0, 0, offset1);
}
...
void get_chipset_id(
	...
	WORD *PCHDID)
{
	DWORD platform = read_pci_dword(0, 0, 0, 0);
	*platformVID = platform & 0xFFFF;
	*platformDID = platform >> 0x10;
	DWORD pch = read_pci_dword(0, 0x1f, 0, 0);
	*PCHVID = pch & 0xFFFF;
	*PCHDID = pch >> 0x10;
}
...
void intel_get_chipset_information() {
	...
	read_spi_bar_bios_bfpreg((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &BFPREG);
	read_spi_bar_hsfs_ctl((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &HSFS_CTL);
	read_spi_bar_faddr((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &BIOS_FADDR);
	read_spi_bar_dlock((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &BIOS_DLOCK);
	read_spi_bar_freg0((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FREG0);
	read_spi_bar_freg1((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FREG1);
	read_spi_bar_freg2((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FREG2);
	read_spi_bar_freg3((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FREG3);
	read_spi_bar_freg4((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FREG4);
	read_spi_bar_freg5((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FREG5);
	read_spi_bar_fpr0((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FPR0);
	read_spi_bar_fpr1((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FPR1);
	read_spi_bar_fpr2((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FPR2);
	read_spi_bar_fpr3((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FPR3);
	read_spi_bar_fpr4((DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4, &FPR4);
...
void intel_dump_spi_flash(const char *output_filename) {
	...
	read_spi_interface_bar0_mmio(&SPIBar0Mmio);
	DWORD64 SPIBAR_ADDR = (DWORD64)((PCI_BAR *)&SPIBar0Mmio)->BaseAddress << 4;

	read_spi_bar_bios_bfpreg(SPIBAR_ADDR, &BFPREG);
