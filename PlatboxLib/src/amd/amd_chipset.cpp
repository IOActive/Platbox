...
void _read_lpc_isa_bridge() {	
    ...
    for (int i = 0 ; i < sizeof(LPC_ISA_Bridge)/sizeof(DWORD); i++) {
...
void amd_print_smm_base() {
    DWORD64 smm_base = amd_retrieve_smm_base();
...
void amd_print_apic_bar() {
    DWORD64 apic_bar = amd_retrieve_apic_bar();
...
void amd_print_hwcr_smmlock() {
    DWORD64 hwcr = amd_retrieve_hwcr_smmlock();
...
DWORD amd_retrieve_root_complex_pci_control() {
    DWORD pci_control = read_pci_dword(0, 0, 0, ROOT_COMPLEX_PCI_CONTROL_OFFSET/sizeof(DWORD));
    return pci_control;
}

void amd_print_root_complex_pci_control() {
	// D0F0x4C PCI Control
	DWORD pci_control = amd_retrieve_root_complex_pci_control();
...
void amd_print_root_complex_nb_control() {
    ...
    write_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX/sizeof(DWORD), ROOT_COMPLEX_MISC_INDEX_OFFSET_NORTHBRIDGE_CONTROL);
	DWORD nb_control = read_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX_DATA/sizeof(DWORD));
...
void amd_print_root_complex_mmio_range() {
	...
	write_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX/sizeof(DWORD), ROOT_COMPLEX_MISC_INDEX_OFFSET_MMIO_BASE);
	DWORD mmio_base = read_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX_DATA/sizeof(DWORD));

    write_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX/sizeof(DWORD), ROOT_COMPLEX_MISC_INDEX_OFFSET_MMIO_LIMIT);
	DWORD mmio_limit = read_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX_DATA/sizeof(DWORD));
...
void amd_print_root_complex_tom2() {
	...
	write_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX/sizeof(DWORD), ROOT_COMPLEX_MISC_INDEX_OFFSET_TOM2_LOW);
	DWORD tom2_low = read_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX_DATA/sizeof(DWORD));

    write_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX/sizeof(DWORD), ROOT_COMPLEX_MISC_INDEX_OFFSET_TOM2_HIGH);
	DWORD tom2_high = read_pci_dword(0, 0, 0, ROOT_COMPLEX_MISC_INDEX_DATA/sizeof(DWORD));
...
void amd_print_root_complex_tom() {
	...
	DWORD tom = read_pci_dword(0, 0, 0, ROOT_COMPLEX_NORTHBRIDGE_TOP_OF_MEMORY_OFFSET/sizeof(DWORD));
    /*
...
void amd_print_dram_range_base_limit() {
    ...
    for (int i = 0; i < 1; i++) {
        ...
        DWORD base_low   = read_pci_dword(0, 0x18, 1, base_low_offset/sizeof(DWORD));
        DWORD limit_low  = read_pci_dword(0, 0x18, 1, limit_low_offset/sizeof(DWORD));
...
void amd_print_dram_system_address_range() {
	...
	DWORD dram_base_system_address  = read_pci_dword(0, 0x18, 1, D18F1_DRAM_BASE_SYSTEM_ADDRESS_OFFSET/sizeof(DWORD));
    DWORD dram_limit_system_address = read_pci_dword(0, 0x18, 1, D18F1_DRAM_LIMIT_SYSTEM_ADDRESS_OFFSET/sizeof(DWORD));
...
void amd_print_dram_controller_range() {
    ...
    */
	...
	DWORD dram_controller_base  = read_pci_dword(0, 0x18, 1, D18F1_DRAM_CONTROLLER_BASE_RANGE_0_OFFSET/sizeof(DWORD));
    DWORD dram_controller_limit = read_pci_dword(0, 0x18, 1, D18F1_DRAM_CONTROLLER_LIMIT_RANGE_0_OFFSET/sizeof(DWORD));
...
void amd_print_dram_hole() {
    ...
    */
    ...
    DWORD dram_hole_address  = read_pci_dword(0, 0x18, 1, D18F1_DRAM_HOLE_ADDRESS_OFFSET/sizeof(DWORD));
...
void amd_print_memory_controller_configuration_lock() {
    ...
    */
    ...
    DWORD mem_controller_config_low  = read_pci_dword(0, 0x18, 2, D18F2_MEMORY_CONTROLLER_CONFIGURATION_LOW_OFFSET/sizeof(DWORD));
...
void write_rom_protect0() {
    DWORD val = read_pci_dword(0, 0x14, 3, 0x50>>2);
    printf("RomProtect0 val: %08x\n", val);
    ROM_PROTECT *pRomProtect = (ROM_PROTECT *) &val;
    pRomProtect->Range = 1;
    pRomProtect->WriteProtect = 1;
    pRomProtect->RomBase = 0xFF000000 >> 12;
    write_pci_dword(0, 0x14, 3, 0x50>>2, val);
}